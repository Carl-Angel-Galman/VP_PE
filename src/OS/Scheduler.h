...
typedef struct _Scheduler
{
    ...
    uint32_t halTick_1ms;              //!< Timestamp for last execution of 10ms task
        CyclicFunction pTask_1ms;
    ...
    uint32_t halTick_50ms;             //!< Timestamp for last execution of 100ms task
    CyclicFunction pTask_50ms;         //!< Function pointer to 100ms cyclic task function
